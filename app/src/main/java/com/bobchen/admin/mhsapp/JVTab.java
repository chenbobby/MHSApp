...
public class JVTab extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jvtab);
        ...
        query.whereEqualTo("teamRank", "JV");
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> receivedList, ParseException e) {
                ...
                ListView eventListFreshmen = (ListView) findViewById(R.id.lvJV);
                EventListAdapter theAdapter = new EventListAdapter(JVTab.this, listOfEvents);
                ...
                eventListFreshmen.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                        ...
                        Toast.makeText(JVTab.this, tvEventPicked, Toast.LENGTH_SHORT).show();
                        ...
                        gotoEventInfo.setClass(JVTab.this, EventInfoScreen.class);
