...
public class VarsityTab extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_varsity_tab);
        ...
        try {
            ...
            pickedGroupName = ((Tab2) getParent()).getTeamName();
        }
        ...
        query.whereEqualTo("teamRank", "Varsity");
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> receivedList, ParseException e) {
                ...
                ListView eventListFreshmen = (ListView) findViewById(R.id.lvVarsity);
                EventListAdapter theAdapter = new EventListAdapter(VarsityTab.this, listOfEvents);
                ...
                eventListFreshmen.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    //TODO:Changes activity when an item from the list is clicked
                    @Override
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {

                        String tvEventPicked = "You selected " + listOfEvents.get(position).eventName;

                        Toast.makeText(VarsityTab.this, tvEventPicked, Toast.LENGTH_SHORT).show();
                        ...
                        gotoEventInfo.setClass(VarsityTab.this, EventInfoScreen.class);
